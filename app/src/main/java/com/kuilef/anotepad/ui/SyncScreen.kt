...
import com.kuilef.anotepad.drive.DrivePickerActivity
import com.kuilef.anotepad.sync.SyncState
    ...
    val drivePickerLauncher = rememberLauncherForActivityResult(
        ...
        if (result.resultCode == Activity.RESULT_OK && data != null) {
            ...
            if (id.isNullOrBlank()) {
                ...
                viewModel.setFolderError(null)
                viewModel.selectDriveFolder(com.kuilef.anotepad.sync.DriveFolder(id, name ?: id))
            }
        } else {
...
private fun resolveDriveFolder(context: Context, treeUri: Uri): com.kuilef.anotepad.sync.DriveFolder? {
    ...
    return com.kuilef.anotepad.sync.DriveFolder(id = driveId, name = displayName)
}
