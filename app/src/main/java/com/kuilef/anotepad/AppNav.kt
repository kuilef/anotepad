...
import com.kuilef.anotepad.ui.BrowserScreen
import com.kuilef.anotepad.ui.EditorScreen
import com.kuilef.anotepad.ui.SearchScreen
import com.kuilef.anotepad.ui.SettingsScreen
import com.kuilef.anotepad.ui.SyncScreen
import com.kuilef.anotepad.ui.TemplatesScreen
...
fun AppNav(deps: AppDependencies) {
    ...
    NavHost(navController = navController, startDestination = ROUTE_BROWSER) {
        composable(ROUTE_BROWSER) {
            val viewModel: com.kuilef.anotepad.ui.BrowserViewModel = viewModel(factory = factory)
        ...
        composable(
            ...
            val viewModel: com.kuilef.anotepad.ui.EditorViewModel = viewModel(factory = factory)
            val savedStateHandle = navController.currentBackStackEntry?.savedStateHandle
        ...
        composable(
            ...
            val dirArg = backStackEntry.arguments?.getString("dir")
            val viewModel: com.kuilef.anotepad.ui.SearchViewModel = viewModel(factory = factory)
        ...
        composable(
            ...
            val viewModel: com.kuilef.anotepad.ui.TemplatesViewModel = viewModel(factory = factory)
            TemplatesScreen(
                viewModel = viewModel,
                pickMode = mode == "pick",
                onBack = { navController.popBackStack() },
        ...
        composable(ROUTE_SETTINGS) {
            val viewModel: com.kuilef.anotepad.ui.SettingsViewModel = viewModel(factory = factory)
            SettingsScreen(
                viewModel = viewModel,
                onBack = { navController.popBackStack() },
        ...
        composable(ROUTE_SYNC) {
            val viewModel: com.kuilef.anotepad.ui.SyncViewModel = viewModel(factory = factory)
...
private fun resolveDriveFolderName(
    fileRepository: com.kuilef.anotepad.file.FileRepository,
    pickedUri: Uri
): String {
